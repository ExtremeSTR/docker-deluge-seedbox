...
Run with
```docker run -d --name deluge -p 80:80 -p 8112:8112 -p 58846:58846 -p 58847:58847 -p 58847:58847/udp -e DELUGED_USER=username -e DELUGED_USER=password -v /path/to/deluge/data:/home/deluge extremestr/docker-deluge-seedbox:ExtremeSTR```
